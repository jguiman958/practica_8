...
wget https://github.com/PrestaShop/PrestaShop/archive/refs/tags/8.1.2.zip -P /tmp

# Eliminamos instalaciones previas de prestashop
rm -rf /var/www/html/*

# Descomprimimos el .zip en /var/www/html
unzip -u /tmp/8.1.2.zip -d /var/www/html

# Instalamos prestashop.
php /var/www/html/PrestaShop-8.1.2/install-dev/index_cli.php
